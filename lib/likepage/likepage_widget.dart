...
import 'likepage_model.dart';
export 'likepage_model.dart';
              ...
              FutureBuilder<List<UsersRecord>>(
                ...
                builder: (context, snapshot) {
                  ...
                  return Builder(
                    builder: (context) {
                      final likepost2 =
                          widget.likepost?.postLikeBy.toList() ?? [];
                      return ListView.builder(
                        padding: EdgeInsets.zero,
                        shrinkWrap: true,
                        scrollDirection: Axis.vertical,
                        itemCount: likepost2.length,
                        itemBuilder: (context, likepost2Index) {
                          final likepost2Item = likepost2[likepost2Index];
                          return Column(
                            mainAxisSize: MainAxisSize.max,
                            children: [
                              Padding(
                                ...
                                child: StreamBuilder<UsersRecord>(
                                  stream:
                                      UsersRecord.getDocument(likepost2Item),
                                  builder: (context, snapshot) {
                                    // Customize what your widget looks like when it's loading.
                                    if (!snapshot.hasData) {
                                      return Center(
